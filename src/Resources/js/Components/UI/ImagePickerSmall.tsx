...
export default function ImagePickerSmall({ label, value, onChange, error, accept = "image/*" }: ImagePickerSmallProps) {
                ...
                <div className="flex-1 min-w-0 w-full">
                    ...
                    <div className="mt-2 flex flex-col gap-1">
                        <p className="text-xs text-slate-500 dark:text-slate-400 font-medium truncate">
                            {value instanceof File ? `New: ${value.name}` : (typeof value === 'string' ? 'Current image stored' : 'No image selected')}
                        </p>
